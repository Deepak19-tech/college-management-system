...
```bash
git remote add encore encore://college-management-system-h3i2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/college-management-system-h3i2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/college-management-system-h3i2/settings/integrations/github)
